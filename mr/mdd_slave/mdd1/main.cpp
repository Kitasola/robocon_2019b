...
int main() {
        ...
        PidPosition pid_1 = PidPosition(0.1, 0, 0, 0);
        PidPosition pid_2 = PidPosition(0.1, 0, 0, 0);
        
        while (true) {
                get_speed_1 = rotary_inc_1.getSpeed();
                get_speed_2 = rotary_inc_2.getSpeed();

                current_speed_1 = get_speed_1 * diameter * M_PI / 1000.0;
                current_speed_2 = get_speed_2 * diameter * M_PI / 1000.0;

                data_2 = pid_1.control(goal_speed_2, current_speed_2);
                data_1 = pid_2.control(goal_speed_1, current_speed_1);
