...
(cl:in-package rc2019_commander-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <button>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'button)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rc2019_commander-msg:<button> is deprecated: use rc2019_commander-msg:button instead.")))

(cl:ensure-generic-function 'move_angle-val :lambda-list '(m))
(cl:defmethod move_angle-val ((m <button>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc2019_commander-msg:move_angle-val is deprecated.  Use rc2019_commander-msg:move_angle instead.")
  (move_angle m))

(cl:ensure-generic-function 'move_speed-val :lambda-list '(m))
(cl:defmethod move_speed-val ((m <button>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc2019_commander-msg:move_speed-val is deprecated.  Use rc2019_commander-msg:move_speed instead.")
  (move_speed m))

(cl:ensure-generic-function 'turn_right-val :lambda-list '(m))
(cl:defmethod turn_right-val ((m <button>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc2019_commander-msg:turn_right-val is deprecated.  Use rc2019_commander-msg:turn_right instead.")
  (turn_right m))

(cl:ensure-generic-function 'turn_left-val :lambda-list '(m))
(cl:defmethod turn_left-val ((m <button>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc2019_commander-msg:turn_left-val is deprecated.  Use rc2019_commander-msg:turn_left instead.")
  (turn_left m))

(cl:ensure-generic-function 'arm_data-val :lambda-list '(m))
(cl:defmethod arm_data-val ((m <button>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc2019_commander-msg:arm_data-val is deprecated.  Use rc2019_commander-msg:arm_data instead.")
  (arm_data m))

(cl:ensure-generic-function 'calibration-val :lambda-list '(m))
(cl:defmethod calibration-val ((m <button>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc2019_commander-msg:calibration-val is deprecated.  Use rc2019_commander-msg:calibration instead.")
  (calibration m))
