...
class Ptp {
public:
  Ptp(ros::NodeHandle *n, const string &goal, const string &current_point) {
    velocity_pub = n->advertise<geometry_msgs::Pose>(goal, 1);
...
private:
  queue<geometry_msgs::Pose2D> goal_point_list;
