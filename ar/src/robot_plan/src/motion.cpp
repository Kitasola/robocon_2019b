...
int main(int argc, char **argv) {
  ...
  constexpr int CONNECT_VELOCITY = 1200;
  goal_map[2].add(start_x, start_y, start_yaw, 11); // Move: スタートゾーン
  goal_map[2].add(3600, 3500, start_yaw, 0, 0, 0, CONNECT_VELOCITY);
  goal_map[2].add(3600, 5500, start_yaw, 0, 0, 0, 0);
  goal_map[2].add(2850, 5500, start_yaw, 0, 0, -CONNECT_VELOCITY,
                  -CONNECT_VELOCITY);
  goal_map[2].add(2100, 4750, start_yaw, 0, 0, 0, -CONNECT_VELOCITY);
  goal_map[2].add(2150, 3500, start_yaw, 0, 0, CONNECT_VELOCITY,
                  -CONNECT_VELOCITY / 2);
